...
/**
 * Executes transform tests using the {@linkplain JMMAlt} memory model.
 * @author etorlak
 */
public final class JMMAltTransformTests extends TransformTests {
	...
	public void testReorderingWithExernalActions() {
		super.testReorderingWithExernalActions();
	}
}
