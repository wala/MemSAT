...
/**
 * Executes nemos tests using the {@linkplain PRAM} memory model.
 * @author etorlak
 */
public final class PRAMNemosTests extends NemosTests {

	public PRAMNemosTests() {
		super(
			new HashSet<String>(
				Arrays.asList("01", "02", "03", "04", "06", "07", "08", "09", "11", "12", "13", "14", "15")
			)
		);
	}
